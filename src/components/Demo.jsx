...
const Demo = () => {
  ...
  const [getSummary, { isLoading, isFetching, error }] = useLazyGetSummaryQuery();
        ...
        <div className={'flex flex-col gap-1 max-h-60 overflow-y-auto'}>
          {
            allArticles.map((item, index) => (
              ...
              >
                ...
                <p className={'flex-1 font-satoshi text-blue-700 font-medium text-sm truncate text-justify'}>
                  {item.url}
                </p>
              </div>
            ))
